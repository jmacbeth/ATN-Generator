   ...
   '(
     ...
     (c1 (tok l1 voice active form none aspect none auxverb none tense
	  past mood indic aux none time 1 pron none agt c2 obj c3 vs () )) ;; see
        ...
        (c1-test (tok l1 voice passive form none aspect none auxverb none tense
		  past mood indic aux none time 1 pron none agt c2 obj c3 vs () ))
     ...
     (c11 (tok l11 obj c4 pobj p )) ;; to ;; not implemented
     (c12 (tok l12 nbr sing det none ns () ) ) ;; over  ;; not implemented
     ...
     (c20 (tok l-by  nbr sing det none pron none agt* (c1 c10 c14 c17) ns ()) ) ; by John
     ...
     (vp5 (paths ((end-punct vp6) (vp6)))) ;; handle end-of-sentence punctuation? not currently handled this way
     (vp6 (paths ((t))))
...
(defun reset-and-gen () 
  ...
  ;; c17 c3 c10 c14 c1
  (setq story-output (post-process-paragraph (remove nil (gen-random-from-list '( c1-test)))))
